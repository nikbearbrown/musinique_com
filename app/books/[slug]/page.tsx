...
export async function generateMetadata({
  ...
  if (!book) return { title: 'Books - Musinique' }
  return {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-10">
          ...
          <div className="flex-1">
            ...
            {book.publisher && (
              <p className="text-sm text-muted-foreground mb-1">Publisher: {book.publisher}</p>
            )}
            {book.isbn && (
              <p className="text-sm text-muted-foreground mb-1">ISBN: {book.isbn}</p>
            )}
            {book.published && (
              <p className="text-sm text-muted-foreground mb-1">Published: {book.published}</p>
            )}
