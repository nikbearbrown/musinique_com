...
export const metadata: Metadata = {
  title: "Privacy Policy - Musinique",
  description: "Privacy policy for Musinique",
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              Welcome to Musinique. We are committed to protecting your personal information and your right to privacy.
