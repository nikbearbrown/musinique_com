...
export const metadata: Metadata = {
  title: 'Cookie Policy - Musinique',
  description: 'Cookie policy for Musinique and musinique.com',
}
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              ...
              This Cookie Policy explains how <strong>Musinique</strong> uses cookies and similar technologies on{' '}
              <strong>musinique.com</strong>.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>
                <strong>Spotify embeds</strong> — Music player embeds from Spotify may set cookies. See{' '}
                <a href="https://www.spotify.com/legal/privacy-policy/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                  Spotify&apos;s Privacy Policy
                </a>.
              </li>
              <li>
                <strong>YouTube embeds</strong> — Video embeds from YouTube may set cookies. See{' '}
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              <li>Third-party embeds (tools, Spotify player) may not function correctly</li>
